...
public class AppTest
    extends TestCase
{
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/dms?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    private static final String JDBC_USER_NAME = "whnr";
    ...
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"ranging_record"};
